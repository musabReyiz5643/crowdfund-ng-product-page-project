...
const ProductPageMain = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-gray-100/50 flex flex-col z-50 relative items-center ">
      <div className="relative w-full ">
        <picture>
          <source
            srcSet={data?.heroSection.backgroundImages.desktop}
            media="(min-width:769px)"
          />
          <img
            src={data?.heroSection.backgroundImages.mobile}
            alt="Not Avaliable"
